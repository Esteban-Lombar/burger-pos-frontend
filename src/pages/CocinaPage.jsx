...
// ✅ mismos precios que Mesero
const ADDON_PRICES = {
  extraMeat: 5000,
  extraBacon: 3000,
  extraCheese: 3000,
  fries: 3000,       // papas del combo
  extraFries: 5000,  // adic papas
  drink: 3000,       // gaseosa del combo
...
export default function CocinaPage() {
  ...
  const openItemEditor = (order, index) => {
    ...
    setConfig({
      ...
      includedMeats: item.burgerConfig?.includedMeats || 1, // 👈 importante
  ...
  const saveItemChanges = async () => {
    try {
      ...
      newItems[index] = {
        ...
        // ✅ mantener basePrice para futuras ediciones correctas
        basePrice,
      ...
      // backend recalcula total general si envías items
  ...
  // ✅ changeStatus robusto (sí, cambia esa parte)
